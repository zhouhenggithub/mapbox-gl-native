...
class LocationComponentTest {
  ...
  @Mock
  private lateinit var currentListener: LocationEngineCallback<LocationEngineResult>
  ...
  fun before() {
    ...
    locationComponent = LocationComponent(mapboxMap, currentListener, locationLayerController, locationCameraController, locationAnimatorCoordinator, staleStateManager, compassEngine, locationEngineProvider)
